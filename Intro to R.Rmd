...
This is a tutorial/teaching tool to help those who are used to using Excel for data maniupation to help them get onboard with R. 
...
Unlike some other programing languages that start indexing at 0 R is similar to how excel numbers it's columns and rows, starting the index at 1. If you need the 5th item in a list, then use the number 5. It's intuitve and will become second nature as you use R more. 


#### Vectors and Variables Examples
